    ...
    <div className="home-container">
      ...
      <section className="goals">
        ...
        <p>
          ...
          platform, CANDY, for updating properties of dynamic networks. Provide
          functionality and tools to create new algorithms or modify existing
          ones, catering to users with varying expertise. Implement CANDY
          platform on distributed and shared memory systems, and GPUs, providing
      ...
      <section className="challenges">
        ...
        <ul>
          ...
          <li>
            Comprehensive cyberinfrastructure to support innovative research in
        ...
        <div className="intellectual-merit-content">
          ...
          <div className="intellectual-merit-text">
            <ul>
              ...
              <li>
                Develop templates for creating new scalable, parallel algorithms
                for dynamic network analysis.
              </li>
              <li>
                Design algorithms to partition streaming sets of nodes and edges
                into network snapshots at changing points.
              </li>
              <li>
      ...
      <section className="broader-impacts">
        ...
        <ul>
          ...
          <li>
            Host workshops, webinars, and tutorials to educate the research and
            broader community about CANDY.
          </li>
          <li>
            Disseminate project outcomes via a dedicated website, invited talks,
            demos, and high-quality publications.
          </li>
          <li>
